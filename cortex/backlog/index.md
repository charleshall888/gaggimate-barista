...
| 28 | Commission the DF64V and run the phased per-coffee profile re-dial | backlog | high | feature | — | 024 | — |
...
- **24** Migrate grinder layer: Sette 270 -> DF64V + SSP Cast Lab Sweet V3
- **28** Commission the DF64V and run the phased per-coffee profile re-dial
