...
A quick reference for grind settings and adjustments. For your personal grind settings that have worked well, see `grind-map.md` in the project root.

> **Deep dive:** Single-dosing tips, clumping/static, calibration, maintenance, burr wear, and troubleshooting in [`../reference/SETTE_270_REFERENCE.md`](../reference/SETTE_270_REFERENCE.md).
